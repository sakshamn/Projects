...
class JobsSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        'https://www.linkedin.com/jobs/search?keywords=&location=New%20Delhi%2C%20Delhi%2C%20India&geoId=&trk=homepage-jobseeker_jobs-search-bar_search-submit&position=1&pageNum=0/'
    ]
    ...
    def parse(self, response):
        ...
        for job in jobs:
            ...
            for subcategory in subcategories:
                links += [f"https://www.linkedin.com/jobs/search?keywords={subcategory}&location=New%20Delhi%2C%20Delhi%2C%20India&geoId=105953070&trk=public_jobs_jobs-search-bar_search-submit&position=1&pageNum=0"]
